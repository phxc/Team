							...
							<div class="page_wrap">
								<div class="page_nation">
									...
									<c:if test="${adpageMaker.prev }">
										<a class="arrow prev" href="Aewol_Food?pageNum=${adpageMaker.adStartPage -1 }">Previous</a>
									</c:if>
									<!-- 2. 페이지번호 활성화 여부 -->
									...
									<c:if test="${adpageMaker.next }">
										<a class="arrow next" href="Aewol_Food?pageNum=${adpageMaker.adEndPage +1 }">Next</a>
									</c:if>
								</div>
							</div>
